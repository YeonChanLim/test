...
public class QnADAOImpl implements QnADAO {
	...
	private static String namespace = "com.ipp.mapper.QnaMapper";
	...
	// 파일 업로드
	/*
	 * @Override public void insertFile(FileVO fVo) throws Exception {
	 * session.insert(namespace+".insertFile", fVo);
	 * 
	 * }
	 */
	/*
	 * @Override public void delete(FileVO fVo) throws Exception { // TODO
	 * Auto-generated method stub
	 * 
	 * }
	 * 
	 * @Override public List<FileVO> list(int proNo) throws Exception { return
	 * session.selectList(namespace+".fileList", proNo); }
	 */
