					...
					<div class="box-body">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">회원 아이디</label> <input type="text"
								name='usid' class="form-control" value="${userVO.usid}"
								readonly="readonly">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">비밀번호</label> <input type="text"
								name='upw' class="form-control" value="${userVO.upw}">
						</div>
						<div class="form-group">
							<label for="exampleInputPassword1">회원명</label>
							<textarea class="form-control" name="uname" rows="3">${userVO.uname}</textarea>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">포인트</label> <input type="text"
								name='upoint' class="form-control" value="${userVO.upoint}">
						</div>
