					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="inputEmail4" class="col-form-label">작성자</label> <input
								type="text" name="register" id="register" value="${login.usid}"
								class="form-control" readonly>
						</div>

						<div class="form-group col-md-6">
							<label for="inputPassword4" class="col-form-label">작성일자<span
								class="must-mark">*</span></label> <input type="text" name="regDate"
								id="regDate" class="form-control" data-toggle="date-picker"
